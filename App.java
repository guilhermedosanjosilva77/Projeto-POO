...
public class App {
    public static void main(String[] args) {
        ...
        System.out.println(
                "========================== QUAL DOS VEICULOS VOCE DESEJA FAZER O GERENCIAMENTO =================");
        ...
        while (n1) {
            ...
            if (ref == 1) {
                ...
                System.out.println("O desgaste para os pneus nessa semana será de aproxidamente: "
                ...
                System.out.println("------------------------------RESULTADO-------------------------");
                System.out.println(
                        "A troca de óleo de seu carro baseando-se na sua distância semanal indica que sua troca de oleo precisa ser feito dentro de: "
                                + carro.calculoDesgastePneu(tempo) + " semanas");

                System.out.println(carro.gerarRelatorio());

            } else { //COLAR AQUI SUA PARTE
